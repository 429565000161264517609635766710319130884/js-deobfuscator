        ...
        await axios(`/users/@me`, {
            ...
            raxConfig: {
                ...
                onRetryAttempt: (_0xa744x14) => {
                    ...
                    console.log(
                        `Retry attempt #${_0xa744x15.currentRetryAttempt}`
                    )
                },
            },
        })
        ...
        .then(async function (_0xa744x13) {
            ...
            if (_0xa744x13.data.icon !== null) {
                await axios
                    ...
                    .then((_0xa744x17) => {
                        Buffer.from(_0xa744x17.data, 'binary').toString(
                            'base64'
                        )
                        global.guildicon =
            ...
            global.guildname =
                _0xa744x13.data.name + ' | Cloned By Social404 On YT'
            global.guildexplicit = _0xa744x13.data.explicit_content_filter
            global.guildnotifications =
                _0xa744x13.data.default_message_notifications
                    ...
                    if (_0xa744x1d.type == 0) {
                        guildchannels.push({
                            ...
                            permission_overwrites:
                                _0xa744x1d.permission_overwrites,
